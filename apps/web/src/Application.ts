...
import { Routing } from '@ra2/util/Routing';
import { Config } from '@ra2/data/Config';
import { IniFile } from '@ra2/data/IniFile';
import { IniSection } from '@ra2/data/IniSection';
import SplashScreenComponent from '@ra2/gui/component/SplashScreen';
import type { ComponentProps } from 'react';
import { CsfFile, CsfLanguage, csfLocaleMap } from '@ra2/data/CsfFile';
import { Strings } from '@ra2/data/Strings';
import { VirtualFile } from '@ra2/data/vfs/VirtualFile';
import { DataStream } from '@ra2/data/DataStream';
import { version as appVersion } from '@ra2/util/version';
import { MixFile } from '@ra2/data/MixFile';
import { GameRes } from '@ra2/engine/gameRes/GameRes';
import { GameResConfig } from '@ra2/engine/gameRes/GameResConfig';
import { GameResSource } from '@ra2/engine/gameRes/GameResSource';
import { LocalPrefs, StorageKey } from '@ra2/util/LocalPrefs';
import type { Viewport, ViewportRect } from '@ra2/gui/Viewport';
import { Gui } from './Gui';
import { BasicErrorBoxApi } from '@ra2/gui/component/BasicErrorBoxApi';
import { Engine } from '@ra2/engine/Engine';
import { ResourceLoader } from '@ra2/engine/ResourceLoader';
import { ImageContext } from '@ra2/gui/component/ImageContext';
import { ConsoleVars } from '@ra2/util/ConsoleVars';
import { GeneralOptions } from '@ra2/gui/screen/options/GeneralOptions';
import { FullScreen } from '@ra2/gui/FullScreen';
import { browserFileSystemAccess } from '@ra2/engine/gameRes/browserFileSystemAccess';
import type { TestToolRuntimeContext } from '@ra2/tools/TestToolSupport';
...
const optionalDevModuleImporters: Record<string, () => Promise<any>> = {
    './tools/VxlTester': () => import('@ra2/tools/VxlTester'),
    './tools/LobbyFormTester': () => import('@ra2/tools/LobbyFormTester'),
    './tools/SoundTester': () => import('@ra2/tools/SoundTester'),
    './tools/BuildingTester': () => import('@ra2/tools/BuildingTester'),
    './tools/InfantryTester': () => import('@ra2/tools/InfantryTester'),
    './tools/AircraftTester': () => import('@ra2/tools/AircraftTester'),
    './tools/VehicleTester': () => import('@ra2/tools/VehicleTester'),
    './tools/TestToolSupport': () => import('@ra2/tools/TestToolSupport'),
    './tools/ShpTester': () => import('@ra2/tools/ShpTester'),
    './tools/WorldSceneTester': () => import('@ra2/tools/WorldSceneTester'),
    './tools/UnitMovementTester': () => import('@ra2/tools/UnitMovementTester'),
    './tools/PerformanceTester': () => import('@ra2/tools/PerformanceTester'),
    './tools/LiveInteractionTester': () => import('@ra2/tools/LiveInteractionTester'),
};
