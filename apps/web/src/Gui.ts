...
import { RootController } from '@ra2/gui/screen/RootController';
import { ScreenType, MainMenuScreenType } from '@ra2/gui/screen/ScreenType';
import { MainMenuRootScreen } from '@ra2/gui/screen/mainMenu/MainMenuRootScreen';
import { HomeScreen } from '@ra2/gui/screen/mainMenu/main/HomeScreen';
import { LanSetupScreen } from '@ra2/gui/screen/mainMenu/lan/LanSetupScreen';
import { StorageScreen } from '@ra2/gui/screen/options/StorageScreen';
import { Config } from '@ra2/data/Config';
import { Strings } from '@ra2/data/Strings';
import { Engine } from '@ra2/engine/Engine';
import { MusicType } from '@ra2/engine/sound/Music';
import { MessageBoxApi } from '@ra2/gui/component/MessageBoxApi';
import { ToastApi } from '@ra2/gui/component/ToastApi';
import { ShpFile } from '@ra2/data/ShpFile';
import { Palette } from '@ra2/data/Palette';
import { UiAnimationLoop } from '@ra2/engine/UiAnimationLoop';
import { Mixer } from '@ra2/engine/sound/Mixer';
import { ChannelType } from '@ra2/engine/sound/ChannelType';
import { AudioSystem } from '@ra2/engine/sound/AudioSystem';
import { Sound } from '@ra2/engine/sound/Sound';
import { SoundSpecs } from '@ra2/engine/sound/SoundSpecs';
import { Music } from '@ra2/engine/sound/Music';
import { MusicSpecs } from '@ra2/engine/sound/MusicSpecs';
import { LocalPrefs, StorageKey } from '@ra2/util/LocalPrefs';
import { GeneralOptions } from '@ra2/gui/screen/options/GeneralOptions';
import { FullScreen } from '@ra2/gui/FullScreen';
import { Pointer } from '@ra2/gui/Pointer';
import { CanvasMetrics } from '@ra2/gui/CanvasMetrics';
import { createMobileTouchControls } from '@ra2/gui/MobileTouchControls';
import { ErrorHandler } from '@ra2/gui/ErrorHandler';
import { ResourceLoader } from '@ra2/engine/ResourceLoader';
import { MapFileLoader } from '@ra2/gui/screen/game/MapFileLoader';
import { LoadingScreenApiFactory } from '@ra2/gui/screen/game/loadingScreen/LoadingScreenApiFactory';
import { GameLoader } from '@ra2/gui/screen/game/GameLoader';
...
import { GameResConfig } from '@ra2/engine/gameRes/GameResConfig';
import { KeyBinds } from '@ra2/gui/screen/game/worldInteraction/keyboard/KeyBinds';
import { ClientApi } from './ClientApi.js';
import type { ViewportRect } from '@ra2/gui/Viewport';
import { attachPerformanceOptions, installPerformanceDebugApi } from '@ra2/util/performance/PerformanceRuntime';
export class Gui {
    ...
    private async navigateToMainMenu(): Promise<void> {
        ...
        const { SkirmishScreen } = await import('@ra2/gui/screen/mainMenu/lobby/SkirmishScreen');
        subScreens.set(MainMenuScreenType.Skirmish, SkirmishScreen);
        const { MapSelScreen } = await import('@ra2/gui/screen/mainMenu/mapSel/MapSelScreen');
        subScreens.set(MainMenuScreenType.MapSelection, MapSelScreen);
        const { TestEntryScreen } = await import('@ra2/gui/screen/mainMenu/main/TestEntryScreen');
        subScreens.set(MainMenuScreenType.TestEntry, TestEntryScreen);
        subScreens.set(MainMenuScreenType.LanSetup, LanSetupScreen);
        const { InfoAndCreditsScreen } = await import('@ra2/gui/screen/mainMenu/infoAndCredits/InfoAndCreditsScreen');
        const { CreditsScreen } = await import('@ra2/gui/screen/mainMenu/credits/CreditsScreen');
        ...
        const { OptionsScreen } = await import('@ra2/gui/screen/options/OptionsScreen');
        const { SoundOptsScreen } = await import('@ra2/gui/screen/options/SoundOptsScreen');
        const { KeyboardScreen } = await import('@ra2/gui/screen/options/KeyboardScreen');
        ...
        const { ReplaySelScreen } = await import('@ra2/gui/screen/replay/ReplaySelScreen');
        subScreens.set(MainMenuScreenType.ReplaySelection, ReplaySelScreen);
        const { ReplayManager } = await import('@ra2/gui/ReplayManager');
        let replayManager: any;
        try {
            const replayDirHandle = await Engine.getReplayDir();
            if (replayDirHandle) {
                const { RealFileSystemDir } = await import('@ra2/data/vfs/RealFileSystemDir');
                const { ReplayStorageFileSystem } = await import('@ra2/gui/replay/ReplayStorageFileSystem');
        ...
        if (!replayManager) {
            const { ReplayStorageMemStorage } = await import('@ra2/gui/replay/ReplayStorageMemStorage');
        ...
        const { GameScreen } = await import('@ra2/gui/screen/game/GameScreen');
        ...
        gameMenuSubScreens.set((await import('@ra2/gui/screen/game/gameMenu/ScreenType')).ScreenType.Home, new (await import('@ra2/gui/screen/game/gameMenu/GameMenuHomeScreen')).GameMenuHomeScreen(this.strings, this.fullScreen!));
        gameMenuSubScreens.set((await import('@ra2/gui/screen/game/gameMenu/ScreenType')).ScreenType.Diplo, new (await import('@ra2/gui/screen/game/gameMenu/DiploScreen')).DiploScreen(this.strings, this.jsxRenderer!, this.renderer!, Engine.getMpModes() as any, tauntsEnabled, mutedPlayers));
        gameMenuSubScreens.set((await import('@ra2/gui/screen/game/gameMenu/ScreenType')).ScreenType.ConnectionInfo, new (await import('@ra2/gui/screen/game/gameMenu/ConnectionInfoScreen')).ConnectionInfoScreen(this.strings, this.jsxRenderer!));
        gameMenuSubScreens.set((await import('@ra2/gui/screen/game/gameMenu/ScreenType')).ScreenType.QuitConfirm, new (await import('@ra2/gui/screen/game/gameMenu/QuitConfirmScreen')).QuitConfirmScreen(this.strings));
        gameMenuSubScreens.set((await import('@ra2/gui/screen/game/gameMenu/ScreenType')).ScreenType.Options, new (await import('@ra2/gui/screen/options/OptionsScreen')).OptionsScreen(this.strings, this.jsxRenderer!, this.generalOptions!, this.localPrefs, this.fullScreen!, true, false));
        gameMenuSubScreens.set((await import('@ra2/gui/screen/game/gameMenu/ScreenType')).ScreenType.OptionsSound, new (await import('@ra2/gui/screen/options/SoundOptsScreen')).SoundOptsScreen(this.strings, this.jsxRenderer!, this.mixer!, this.music!, this.localPrefs));
        gameMenuSubScreens.set((await import('@ra2/gui/screen/game/gameMenu/ScreenType')).ScreenType.OptionsKeyboard, new (await import('@ra2/gui/screen/options/KeyboardScreen')).KeyboardScreen(this.strings, this.jsxRenderer!, this.keyBinds!));
        ...
        const { ReplayScreen } = await import('@ra2/gui/screen/replay/ReplayScreen');
    ...
    async destroy(): Promise<void> {
        ...
        try {
            const { ShpBuilder } = await import('@ra2/engine/renderable/builder/ShpBuilder');
            if (ShpBuilder?.clearCaches) {
                ShpBuilder.clearCaches();
                console.log('[Gui] Cleared ShpBuilder caches');
            }
            const TexUtils = await import('@ra2/engine/gfx/TextureUtils');
