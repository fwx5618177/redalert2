import * as mapObjects from "@ra2/data/MapObjects";
import { IniFile } from "@ra2/data/IniFile";
import { TheaterType } from "@ra2/engine/TheaterType";
import * as stringUtil from "@ra2/util/string";
import { Format5 } from "@ra2/data/encoding/Format5";
import { RgbBitmap } from "@ra2/data/Bitmap";
import { TagsReader } from "@ra2/data/map/tag/TagsReader";
import { TriggerReader } from "@ra2/data/map/trigger/TriggerReader";
import { DataStream } from "@ra2/data/DataStream";
import { MapLighting } from "@ra2/data/map/MapLighting";
import { CellTagsReader } from "@ra2/data/map/tag/CellTagsReader";
import { Variable } from "@ra2/data/map/Variable";
import { SpecialFlags } from "@ra2/data/map/SpecialFlags";
type MapTile = {
    dx: number;
    dy: number;
    rx: number;
