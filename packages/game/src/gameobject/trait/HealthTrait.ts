...
import { InflictDamageEvent } from '@ra2/game/event/InflictDamageEvent';
import { NotifyHeal } from './interface/NotifyHeal';
import { HealthLevel } from '@ra2/game/gameobject/unit/HealthLevel';
import { NotifyTick } from './interface/NotifyTick';
import { HealthChangeEvent } from '@ra2/game/event/HealthChangeEvent';
