import { OctreeContainer } from '@ra2/engine/gfx/OctreeContainer';
import { World } from '@ra2/game/World';
import { WorldScene } from '@ra2/engine/renderable/WorldScene';
import { Camera } from '@ra2/engine/gfx/Camera';
...
import { Renderable } from '@ra2/engine/renderable/Renderable';
export class RenderableManager {
    ...
    onObjectPositionChanged(gameObject: GameObject, tileChanged: boolean): void {
        ...
        if (!(gameObject.isTechno() && gameObject.rules.isLightpost)) {
            this.container.updateChild(renderable as any as import('@ra2/engine/gfx/RenderableContainer').Renderable);
        }
    }
