import { NotifySpawn } from "@ra2/game/trait/interface/NotifySpawn";
import { NotifyUnspawn } from "@ra2/game/trait/interface/NotifyUnspawn";
import { NotifyPower } from "@ra2/game/trait/interface/NotifyPower";
import { PowerTrait, PowerLevel } from "@ra2/game/player/trait/PowerTrait";
import { RadarOnOffEvent } from "@ra2/game/event/RadarOnOffEvent";
import { NotifyOwnerChange } from "@ra2/game/trait/interface/NotifyOwnerChange";
import { RangeHelper } from "@ra2/game/gameobject/unit/RangeHelper";
import { RadarRules, RadarEventType } from "@ra2/game/rules/general/RadarRules";
import { RadarEvent } from "@ra2/game/event/RadarEvent";
import { NotifyAttack } from "@ra2/game/trait/interface/NotifyAttack";
