...
import { MoveOrder } from "@ra2/game/order/MoveOrder";
    ...
    static async main(mixFileLoader: any, gameMapFile: any, parentElement: HTMLElement, _strings: any, context: TestToolRuntimeContext = {}): Promise<void> {
        ...
        const onMouseDown = (ev: any) => {
            ...
            if (this.pointerEvents)
                // @ts-expect-error TS2341 — pre-existing private-property
                // toggle from outside PointerEvents; intentional in this
                // dev tester to gate raycasts during drag.
        ...
        const onMouseUp = (ev: any) => {
            ...
            this.isDragging = false;
            if (this.pointerEvents)
                // @ts-expect-error TS2341 — see comment above; restoring
                // raycast after drag.
