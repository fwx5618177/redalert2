...
import type { Palette } from '@ra2/data/Palette';
import type { LazyResourceCollection } from './LazyResourceCollection';
import type { TmpFile } from '@ra2/data/TmpFile';
import type { IniFile } from '@ra2/data/IniFile';
import type { FileSystem } from '@ra2/data/vfs/FileSystem';
