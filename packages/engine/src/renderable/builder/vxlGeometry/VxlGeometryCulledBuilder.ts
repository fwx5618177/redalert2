...
export class VxlGeometryCulledBuilder {
    build(e: any) {
        ...
        // T is the vertex count produced by the loop above; outer `t` is the
        // BoxGeometry template — using `t` here was a pre-existing typo that
        // produced NaN-sized Float32Arrays. Tsc surfaced it during the
        // BoxBufferGeometry → BoxGeometry rename.
