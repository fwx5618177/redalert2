...
import { BufferGeometryUtils } from '@ra2/engine/gfx/BufferGeometryUtils';
export class VxlGeometryNaiveBuilder {
    build(vxl: any): THREE.BufferGeometry {
        ...
        // BoxGeometry's normal attribute is always Float32Array in practice;
        // the typed-array union signature is broader. Narrow at the boundary.
        const normalArray = boxGeometry.getAttribute("normal").array as Float32Array;
    ...
    private createPositionAttr(vxl: any, voxels: any[], boxGeometry: THREE.BoxGeometry): THREE.BufferAttribute {
    ...
    private createIndexAttr(voxels: any[], boxGeometry: THREE.BoxGeometry, vertexCount: number): THREE.BufferAttribute {
