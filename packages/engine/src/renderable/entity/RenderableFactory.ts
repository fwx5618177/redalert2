import { Building } from "@ra2/engine/renderable/entity/Building";
import { Vehicle } from "@ra2/engine/renderable/entity/Vehicle";
import { Terrain } from "@ra2/engine/renderable/entity/Terrain";
import { Overlay } from "@ra2/engine/renderable/entity/Overlay";
import { Smudge } from "@ra2/engine/renderable/entity/Smudge";
import { AnimationType } from "@ra2/engine/renderable/entity/building/AnimationType";
import { Infantry } from "@ra2/engine/renderable/entity/Infantry";
import { PipOverlay } from "@ra2/engine/renderable/entity/PipOverlay";
import { Aircraft } from "@ra2/engine/renderable/entity/Aircraft";
import { TransientAnim } from "@ra2/engine/renderable/entity/TransientAnim";
import { Projectile } from "@ra2/engine/renderable/entity/Projectile";
import { ObjectType } from "@ra2/engine/type/ObjectType";
import { HarvesterPlugin } from "@ra2/engine/renderable/entity/plugin/HarvesterPlugin";
import { Anim } from "@ra2/engine/renderable/entity/Anim";
import { MoveSoundFxPlugin } from "@ra2/engine/renderable/entity/plugin/MoveSoundFxPlugin";
import { VehicleDisguisePlugin } from "@ra2/engine/renderable/entity/plugin/VehicleDisguisePlugin";
import { ChronoSparkleFxPlugin } from "@ra2/engine/renderable/entity/plugin/ChronoSparkleFxPlugin";
import { TntFxPlugin } from "@ra2/engine/renderable/entity/plugin/TntFxPlugin";
import { MindControlLinkPlugin } from "@ra2/engine/renderable/entity/plugin/MindControlLinkPlugin";
import { InfantryDisguisePlugin } from "@ra2/engine/renderable/entity/plugin/InfantryDisguisePlugin";
import { PsychicDetectPlugin } from "@ra2/engine/renderable/entity/building/PsychicDetectPlugin";
import { TrailerSmokePlugin } from "@ra2/engine/renderable/entity/plugin/TrailerSmokePlugin";
import { DamageSmokePlugin } from "@ra2/engine/renderable/entity/plugin/DamageSmokePlugin";
import { LocomotorType } from "@ra2/game/type/LocomotorType";
import { ShipWakeTrailPlugin } from "@ra2/engine/renderable/entity/plugin/ShipWakeTrailPlugin";
import { ObjectCloakPlugin } from "@ra2/engine/renderable/entity/plugin/ObjectCloakPlugin";
import { Debris } from "@ra2/engine/renderable/entity/Debris";
import { ShpAggregator } from "@ra2/engine/renderable/builder/ShpAggregator";
interface Position {
    x: number;
    y: number;
}
