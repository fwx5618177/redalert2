import * as ShpBuilder from "@ra2/engine/renderable/builder/ShpBuilder";
import * as DamageType from "@ra2/engine/renderable/entity/building/DamageType";
import * as AnimationType from "@ra2/engine/renderable/entity/building/AnimationType";
import * as OverlayUtils from "@ra2/engine/gfx/OverlayUtils";
import * as GameObjectBuilding from "@ra2/game/gameobject/Building";
import * as Animation from "@ra2/engine/Animation";
import * as wallTypes from "@ra2/game/map/wallTypes";
import * as Coords from "@ra2/util/Coords";
import * as math from "@ra2/util/math";
import * as AnimProps from "@ra2/engine/AnimProps";
import * as WithPosition from "@ra2/engine/renderable/WithPosition";
import * as ShpRenderable from "@ra2/engine/renderable/ShpRenderable";
import * as ImageFinder from "@ra2/engine/ImageFinder";
import { MissingImageError } from "@ra2/engine/ImageFinder";
import * as DebugUtils from "@ra2/engine/gfx/DebugUtils";
import * as MapSpriteTranslation from "@ra2/engine/renderable/MapSpriteTranslation";
import * as BuildingAnimArtProps from "@ra2/engine/renderable/entity/building/BuildingAnimArtProps";
import * as typeGuard from "@ra2/util/typeGuard";
import * as HighlightAnimRunner from "@ra2/engine/renderable/entity/HighlightAnimRunner";
import * as TechnoRules from "@ra2/game/rules/TechnoRules";
import * as AttackTrait from "@ra2/game/gameobject/trait/AttackTrait";
import * as SideType from "@ra2/game/SideType";
import * as FactoryTrait from "@ra2/game/gameobject/trait/FactoryTrait";
import * as UnitRepairTrait from "@ra2/game/gameobject/trait/UnitRepairTrait";
import * as DeathType from "@ra2/game/gameobject/common/DeathType";
import * as InvulnerableAnimRunner from "@ra2/engine/renderable/entity/InvulnerableAnimRunner";
import * as BuildingShpHelper from "@ra2/engine/renderable/entity/building/BuildingShpHelper";
import * as ExtraLightHelper from "@ra2/engine/renderable/entity/unit/ExtraLightHelper";
import * as AlphaRenderable from "@ra2/engine/renderable/AlphaRenderable";
import * as DebugRenderable from "@ra2/engine/renderable/DebugRenderable";
import * as MathUtils from "@ra2/engine/gfx/MathUtils";
