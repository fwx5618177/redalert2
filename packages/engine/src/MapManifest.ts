import { IniFile, IniSection } from '@ra2/data/IniFile';
import type { GameModeEntry } from '@ra2/game/ini/GameModes';
import type { VirtualFile } from '@ra2/data/vfs/VirtualFile';
