...
import { PlayerConnectionStatus } from '@ra2/network/gamestate/PlayerConnectionStatus';
import { CountryIcon } from '@ra2/gui/component/CountryIcon';
import { NO_TEAM_ID, OBS_COUNTRY_NAME } from '@ra2/game/gameopts/constants';
import { formatTeamId } from '@ra2/gui/component/TeamSelect';
interface Country {
    name: string;
    uiName?: string;
    side?: any;
