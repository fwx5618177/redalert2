// @ts-nocheck — Mod archive importer; new Error({cause}) shape mismatch with @types/error and DataStream casts.
...
import { ModManager } from "@ra2/gui/screen/mainMenu/modSel/ModManager";
import { ModMeta } from "@ra2/gui/screen/mainMenu/modSel/ModMeta";
