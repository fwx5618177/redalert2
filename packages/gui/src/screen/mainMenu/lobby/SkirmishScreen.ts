...
import { BotRegistry } from '@ra2/game/ai/thirdpartbot/BotRegistry';
...
export class SkirmishScreen extends MainMenuScreen {
    ...
    private showBotUploadDialog(): void {
        ...
        fileInput?.addEventListener('change', async () => {
            ...
            try {
                const { BotUploader } = await import('@ra2/game/ai/thirdpartbot/BotUploader');
    ...
    private refreshBotList(): void {
        ...
        import('@ra2/game/ai/thirdpartbot/BotRegistry').then(({ BotRegistry }) => {
