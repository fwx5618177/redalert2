...
import { GameOpts, AiDifficulty } from '@ra2/game/gameopts/GameOpts';
import {
    RANDOM_COUNTRY_ID,
    RANDOM_COLOR_ID,
    RANDOM_START_POS,
    ...
    RANDOM_COLOR_NAME,
    aiUiNames,
} from '@ra2/game/gameopts/constants';
import { LobbyType, SlotOccupation, PlayerStatus, SlotType as UiSlotType } from '@ra2/gui/screen/mainMenu/lobby/component/viewmodel/lobby';
import { SlotType as NetSlotType, SlotInfo } from '@ra2/network/gameopt/SlotInfo';
...
import { Serializer } from '@ra2/network/gameopt/Serializer';
