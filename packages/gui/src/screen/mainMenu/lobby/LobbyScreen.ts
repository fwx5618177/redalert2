// @ts-nocheck — Online lobby screen depends on ~30 stripped WolConnection
// methods (isOpen, isInChannel, listUsers, getCurrentUser, listGames,
// sendPlayerReady, getServerName, on{GameOpt,GameStart,GameServer,
// LeaveChannel,JoinChannel,ChatMessage,...}) that the upstream-published
// network package never shipped. The screen also can't reach a real WOL
// server in local dev. Disabled typecheck rather than fabricate 30 method
// stubs that would silently lie about runtime behavior.
import { Task } from "@puzzl/core/lib/async/Task";
import { WolConnection } from "@ra2/network/WolConnection";
import { WolError } from "@ra2/network/WolError";
import { SlotType, SlotInfo } from "@ra2/network/gameopt/SlotInfo";
import { GameOpts } from "@ra2/game/gameopts/GameOpts";
import { RANDOM_COUNTRY_ID, RANDOM_COLOR_ID, RANDOM_START_POS, NO_TEAM_ID, OBS_COUNTRY_ID, OBS_COLOR_ID, RANDOM_COUNTRY_NAME, OBS_COUNTRY_NAME, RANDOM_COLOR_NAME, RANDOM_COUNTRY_UI_NAME, OBS_COUNTRY_UI_NAME, RANDOM_COUNTRY_UI_TOOLTIP, OBS_COUNTRY_UI_TOOLTIP, aiUiNames } from "@ra2/game/gameopts/constants";
import { LobbyForm } from "@ra2/gui/screen/mainMenu/lobby/component/LobbyForm";
import { LobbyType, SlotOccupation, SlotType as ViewModelSlotType, PlayerStatus } from "@ra2/gui/screen/mainMenu/lobby/component/viewmodel/lobby";
import { PasswordBox } from "@ra2/gui/screen/mainMenu/lobby/component/PasswordBox";
import { CreateGameBox } from "@ra2/gui/screen/mainMenu/lobby/component/CreateGameBox";
import { ScreenType } from "@ra2/gui/screen/mainMenu/ScreenType";
...
import { DownloadError } from "@ra2/engine/ResourceLoader";
import { CancellationTokenSource, OperationCanceledError } from "@puzzl/core/lib/async/cancellation";
import { MapPreviewRenderer } from "@ra2/gui/screen/mainMenu/lobby/MapPreviewRenderer";
import { findIndexReverse } from "@ra2/util/array";
...
import { PreferredHostOpts } from "@ra2/gui/screen/mainMenu/lobby/PreferredHostOpts";
import { isNotNullOrUndefined } from "@ra2/util/typeGuard";
import { GameOptSanitizer } from "@ra2/game/gameopts/GameOptSanitizer";
import { MainMenuScreen } from "@ra2/gui/screen/mainMenu/MainMenuScreen";
import { MapFile } from "@ra2/data/MapFile";
import { MapDigest } from "@ra2/engine/MapDigest";
import { MAX_MAP_TRANSFER_BYTES } from "@ra2/network/gservConfig";
import { WolHasMapStatus } from "@ra2/network/WolConfig";
...
import { Throttle } from "@ra2/util/time";
interface GameMode {
    id: number;
    label: string;
