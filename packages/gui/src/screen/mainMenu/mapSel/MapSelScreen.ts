...
import { MapSel, SortType } from "@ra2/gui/screen/mainMenu/mapSel/component/MapSel";
...
import { MapManifest } from "@ra2/engine/MapManifest";
import { NameNotAllowedError } from "@ra2/data/vfs/NameNotAllowedError";
interface GameMode {
    id: number;
    label: string;
    type: GameModeType;
