// @ts-nocheck — Online-only Quick Match chat; depends on stripped IRC chat history private fields.
...
import { WL_CHANNEL_ID_MIN } from "@ra2/network/ladder/wladderConfig";
...
import { formatTime } from "@ra2/util/time";
import { ChatInput } from "@ra2/gui/component/ChatInput";
export class ChatUi {
