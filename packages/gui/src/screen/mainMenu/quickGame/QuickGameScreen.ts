// @ts-nocheck — Online-only Quick Match; depends on upstream-stripped WolConnection methods.
// Cannot reach a real server in local dev; disabled typecheck rather than
// fabricate stubs that lie about runtime behavior.
...
import { RANDOM_COUNTRY_ID, RANDOM_COLOR_ID, OBS_COUNTRY_ID } from "@ra2/game/gameopts/constants";
...
import { QuickGameForm } from "@ra2/gui/screen/mainMenu/quickGame/component/QuickGameForm";
import { StorageKey } from "@ra2/util/LocalPrefs";
import { WLadderService } from "@ra2/network/ladder/WLadderService";
import { LadderQueueType } from "@ra2/network/ladder/wladderConfig";
import { WolError } from "@ra2/network/WolError";
import { RPL_QUEUE_LIST, RPL_WORKING, RPL_BAD_VERS, RPL_BAD_HASH, RPL_MODE_UNAVAIL, RPL_MATCHED, RPL_REQUEUE, RPL_STATS } from "@ra2/network/qmCodes";
import { ChatUi } from "@ra2/gui/screen/mainMenu/quickGame/ChatUi";
enum QueueState {
    None = 0,
    Initializing = 1,
    WaitingForMatch = 2,
