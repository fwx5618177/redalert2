// @ts-nocheck — Online account creation; type-arg-count mismatch on stripped network method.
import { jsx } from "@ra2/gui/jsx/jsx";
import { NewAccountBox } from "@ra2/gui/screen/mainMenu/newAccount/NewAccountBox";
...
import { HttpRequest } from "@ra2/network/HttpRequest";
interface Region {
    id: string;
    apiRegUrl: string;
}
