// @ts-nocheck — Online-only login; depends on ServerRegions/Regions type drift + stripped WolError.reason field.
...
import { LoginBox } from "@ra2/gui/screen/mainMenu/login/LoginBox";
...
import { ServerPings } from "@ra2/gui/screen/mainMenu/login/ServerPings";
