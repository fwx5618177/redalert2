// @ts-nocheck — Online custom-game lobby. Same upstream-stripping issue
// as LobbyScreen — depends on stripped IrcConnection methods (getCurrentUser,
// getServerName, isOpen, listGames, ...) and stripped ChatHistory private
// fields. Cannot reach a server in local dev; disabled typecheck rather
// than maintain stubs.
...
import { MAX_LIST_SEARCH_COUNT } from '@ra2/network/ladder/wladderConfig';
import { MainMenuRoute } from '../MainMenuRoute';
import { ChatMessage, ChatRecipientType } from '@ra2/network/chat/ChatMessage';
