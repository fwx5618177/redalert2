// @ts-nocheck — Online-only ranking widget; depends on stripped WLadderService methods (getAvailableSeasons/getTopPlayers) and SEARCH_LIMIT export.
...
import { SEARCH_LIMIT } from '@ra2/network/ladder/wladderConfig';
